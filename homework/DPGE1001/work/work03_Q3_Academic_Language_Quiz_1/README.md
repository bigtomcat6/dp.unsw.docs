...
<details>
  ...
  <ul>
  <li><select disabled><option>, (comma)</option></select></li>
  <li> <select disabled><option>. (full stop)</option></select></li>
  <li> <select disabled><option>: (colon)</option></select></li>
  <li> <select disabled><option>? (question mark)</option></select></li>
  <li> <select disabled><option>" (quotation mark)</option></select></li>
  <li> <select disabled><option>( ) (parentheses)</option></select></li>
  <li> <select disabled><option>; (semicolon)</option></select></li>
  <li> <select disabled><option>... (ellipsis)</option></select></li>
  <li> <select disabled><option>' (apostrophe)</option></select></li>
  <li> <select disabled><option>- (hyphen)</option></select></li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <img src="/homework/DPGE1001/work/work03_Q3_Academic_Language_Quiz_1/./file/work03png01.png" data-origin="./file/work03png01.png" alt="logo">
</details>
...
In 2011, Morello was jointly awarded the Eureka Prize for Scientific Research.<br>
 <select><option selected="selected" value="0"></option><option value="1">An introductory element in the sentence.</option><option value="2">A removable element (phrase or clause that can be removed and the sentence still makes sense).</option><option value="3">A dependent clause at the beginning of a sentence.</option><option value="4">Separate items in a list.</option></select>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li> <select disabled><option>A removable element (phrase or clause that can be removed and the sentence still makes sense).</option></select></li>
  <li> <select disabled><option>An introductory element in the sentence.</option></select></li>
  <li> <select disabled><option>Separate items in a list.</option></select></li>
  <li> <select disabled><option>A dependent clause at the beginning of a sentence.</option></select></li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> b. Run-on sentence error</li>
  </ul>
</details>
...
Amanda has a good job, so she never has to worry about money.
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> c. No error</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> a. Comma splice error</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <img src="/homework/DPGE1001/work/work03_Q3_Academic_Language_Quiz_1/./file/work03png02.png" data-origin="./file/work03png02.png" alt="logo">
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> b. Incorrect</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> a. Correct</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> b. The underlined clause is a dependent clause.</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> a. The underlined clause is an independent clause.</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> a. This sentence has one clause.</li>
  </ul>
</details>
...
**Identify the following sentence types.**
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> a. Simple</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked disabled> d. Fragment (incomplete sentence)</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><input type="checkbox" checked="checked" disabled> c. Complex</li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><select disabled><option selected="selected">which was wasted in five cities in Australia.</option></select></li>
  <li><select disabled><option selected="selected">unless sanitary conditions are improved.</option></select></li>
  <li><select disabled><option selected="selected">that more training be given to employees.</option></select></li>
  <li><select disabled><option selected="selected">that there was an increase in the number of accidents.</option></select></li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><code>is collected</code></li>
  <li><code>is transported</code></li>
  <li><code>is separated</code></li>
  <li><code>is mixed</code></li>
  <li><code>is filtered</code></li>
  <li><code>spread</code></li>
  <li><code>is rolled up</code></li>
  <li><code>are combined</code></li>
  <li><code>consist</code></li>
  <li><code>be stuck</code></li>
  <li><code>be adjusted</code></li>
  <li><code>goes</code></li>
  <li><code>are flat-packed</code></li>
  <li><code>is recycled</code></li>
  </ul>
</details>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><select disabled><option selected="selected">more confident</option></select></li>
  <li><select disabled><option selected="selected">more confident</option></select></li>
  <li><select disabled><option selected="selected">less confident</option></select></li>
  <li><select disabled><option selected="selected">less confident</option></select></li>
  <li><select disabled><option selected="selected">more confident</option></select></li>
  <li><select disabled><option selected="selected">more confident</option></select></li>
  <li><select disabled><option selected="selected">less confident</option></select></li>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><select disabled><option selected="selected">favourable</option></select></li>
  <li><select disabled><option selected="selected">minimal</option></select></li>
  <li><select disabled><option selected="selected">vital</option></select></li>
  <li><select disabled><option selected="selected">endeavour</option></select></li>
  <li><select disabled><option selected="selected">thorough</option></select></li>
  <li><select disabled><option selected="selected">obvious</option></select></li>
  </ul>
</details>
...
categorically <select><option selected="selected" value="0">Choose...</option><option value="1">recognise</option><option value="2">recommend</option><option value="3">regret</option><option value="4">encourage</option><option value="5">deny</option></select>
...
<details>
  <summary>📕 <b>Check</b></summary>
  <ul>
  <li><select disabled><option selected="selected">deny</option></select></li>
  <li><select disabled><option selected="selected">recognise</option></select></li>
  <li><select disabled><option selected="selected">encourage</option></select></li>
  <li><select disabled><option selected="selected">recommend</option></select></li>
  <li><select disabled><option selected="selected">regret</option></select></li>
  </ul>
</details>