...
<br>此评估项目将提交给抄袭检查服务（然后，该服务可能会在其数据库中保留评估项目的副本，以便将来进行抄袭检查
  ...
  <details>
  <summary><b>具体Turnition计分标准可以参考我用Google翻译后截取下来的内容：</b></summary>
   <em>*注：下面每个方面里的0、1、2是分数，机翻后排版有问题</em>
<div style="background-color: rgb(243, 247, 249)">
<div style="margin: 10px 10px 10px 10px">
<ul>
  <li>你的主要任务将是写出解释清楚的问题答案。这些必须键入并将提交给 TurnitIn。您的解决方案必须是键入的而不是手写的。</li>
  <li>请使用您的 z 编号来命名您的提交文件。您的书面作品的一半标记将使用下面的评分量规，一半将用于特定答案和部分工作。</li>
  <li>您的最终提交内容将提交给 Turnitin。该系统将您的提交内容与互联网上的其他学生提交内容和来源进行检查。作业必须是您自己的作品，通过Moodle提交，您将声明它是您的作品。在学习和完善您的想法的同时与同龄人一起工作是可以的。让某人校对你的工作以帮助消除语法错误和拼写错误也是可以的（也是一个好主意！）。您不得使用外部网站、服务或聊天系统发布作业问题或寻求帮助。<b>如果您的作品与他人的工作过于匹配，无论是在作业提交中还是在互联网上的来源中，那么您的工作都将因学术不端行为而被转介进行调查。</b></li>


  <li><span class="filter_mathjaxloader_equation" id="yui_3_17_2_1_1655792740686_39"><h4 _msthash="698529" _msttexthash="15094560">标记量规</h4>
<p _msthash="665236" _msttexthash="1390225083">这些问题的标记方式与考试问题和正确证明，论证和解释的分数类似，但此外，将在整个作业中评估以下方面。如果只尝试了部分作业，则此标记将与您已完成的金额大致成比例地减少。</p>
<p><strong _msthash="664183" _msttexthash="6405880">方面 1<br _istranslated="1"></strong></p>
<p _msthash="664313" _msttexthash="100026342">用句子和段落写的作品是否语法正确？</p>
<p _msthash="664443" _msttexthash="2081170">奖</p>
<ul id="yui_3_17_2_1_1655792740686_49">
<li _msthash="669994" _msttexthash="37031735">如果没有句子，则为 0;</li>
<li _msthash="670124" _msttexthash="254355452">1.如果某些部分没有用句子写，语法很差或段落没有在适当的时候使用;</li>
<li id="yui_3_17_2_1_1655792740686_48" _msthash="495781" _msttexthash="116511746">2 如果作品是用语法正确的句子和段落写成的。</li>
</ul>
<p><strong _msthash="664703" _msttexthash="6405997">方面 2</strong></p>
<p _msthash="664833" _msttexthash="979242173">书面解释的水平是否足以让那些不知道如何解决这个问题的人遵循论点？解释是否简明扼要？这些解释是否避免了不必要的细节或不相关的信息？</p>
<p _msthash="664963" _msttexthash="2081170">奖</p>
<ul>
<li _msthash="909831" _msttexthash="130209989">如果解释很少或没有解释或解释得很差，则为0;</li>
<li _msthash="909961" _msttexthash="308485268">1.如果有一些解释，但还不够或不清楚，或者有很多不必要的材料掩盖了论点;</li>
<li _msthash="910091" _msttexthash="387666032">2.如果有充分的解释，让不知道如何解决这个问题的人遵循论点，它是清晰和简洁的。</li>
</ul>
<p><strong _msthash="665223" _msttexthash="6406114">方面 3</strong></p>
<p _msthash="665353" _msttexthash="1012788309">这些论点是否自足，是否可以在不参考问题的情况下理解？结论写得清楚吗？可以通过复制问题来使参数独立，但这必须重新键入，而不仅仅是图像。</p>
<p _msthash="664300" _msttexthash="2081170">奖</p>
<ul>
<li _msthash="908778" _msttexthash="160342949">如果参数不是自足的，并且没有结论性陈述，则为 0;</li>
<li _msthash="908908" _msttexthash="225229602">1 如果论点是自足的，或者有结论性陈述，但不是两者兼而有之;</li>
<li _msthash="909038" _msttexthash="134191291">2 如果论点是自成一体的，并且结论写得很清楚。</li>
</ul>
<p><strong _msthash="664560" _msttexthash="6406231">方面 4</strong></p>
<p _msthash="664690" _msttexthash="29355482">数学参数是否有效。</p>
<p _msthash="664820" _msttexthash="2081170">奖</p>
<ul>
<li _msthash="909610" _msttexthash="125160971">如果多个问题中存在严重的逻辑错误，则为 0;</li>
<li _msthash="909740" _msttexthash="163844694">1 如果参数中有一些无效的部分，但大多数参数是合理的;</li>
<li _msthash="909870" _msttexthash="90179492">如果所有答案在数学上都有效，则为 2。</li>
</ul>
<p><strong _msthash="665080" _msttexthash="6406348">方面 5</strong></p>
<p _msthash="665210" _msttexthash="763926475">方程式排版是使用方程式编辑器还是类似编辑器？文本排版中的数学符号是否为数学符号？方程式和数学表达式的格式是否正确？</p>
<p _msthash="665340" _msttexthash="2081170">奖</p>
<ul>
<li _msthash="910442" _msttexthash="102293984">如果方程式和数学符号排版不正确，则为 0;</li>
<li _msthash="910572" _msttexthash="492942892">1.如果一些方程和数学符号被正确排版，但其他方程和数学符号没有正确排版，或者格式有重大缺陷;</li>
<li _msthash="910702" _msttexthash="226931302">2 如果所有方程式和几乎所有数学符号都正确排版并且格式通常良好。</li>
</ul>
</span>
  </li>
</ul>
...
[Mobius class for MATH1131![logo](../../../../../logosvg01.svg)](https://unsw.mobius.cloud/1103)
</li>
</ul>
...
[Academic integrity and plagiarism![logo](../../../../../logosvg01.svg)](https://student.unsw.edu.au/plagiarism)</li>
</ul>
...
<p>Award</p>
<ul>
<li>0 if there are serious errors of logic in more than one question;</li>
